...
namespace Actaris.Quality.Common.Forms
{
	...
	/// <example>
	/// &lt;configSections&gt;
	/// 	&lt;section name="plugins" type="Actaris.Quality.Common.Forms.PluginsSection, Actaris.Quality.Common.Forms" /&gt;
	/// &lt;/configSections&gt;
	/// </example>
	/// </para>
	/// 
	...
	///			assembly="Actaris.Quality.ERHToolbox.exe" 
	///			type="Actaris.Quality.ERHToolbox.childForms.XmlDocumentForm"
	///  	/&gt;
	/// &lt;/tools&gt;
	/// </example>
	/// </para>
