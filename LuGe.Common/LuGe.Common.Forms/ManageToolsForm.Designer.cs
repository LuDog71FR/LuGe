...
namespace Actaris.Quality.Common.Forms
{
	partial class ManageToolsForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.directoryNamePickerWorkDir = new Actaris.Quality.Common.Forms.DirectoryNamePicker();
			this.labelPosition = new System.Windows.Forms.Label();
			this.fileNamePickerCommand = new Actaris.Quality.Common.Forms.FileNamePicker();
			this.textboxArguments = new Actaris.Quality.Common.Forms.TextboxWithLabel();
			this.textboxTitle = new Actaris.Quality.Common.Forms.TextboxWithLabel();
		...
		private Actaris.Quality.Common.Forms.DirectoryNamePicker directoryNamePickerWorkDir;
		...
		private Actaris.Quality.Common.Forms.FileNamePicker fileNamePickerCommand;
		private Actaris.Quality.Common.Forms.TextboxWithLabel textboxArguments;
		private Actaris.Quality.Common.Forms.TextboxWithLabel textboxTitle;
