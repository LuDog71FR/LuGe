...
namespace LuGe.Common.Collection
{
	...
	/// </summary>
	/// <remarks>
	/// Elements in this collection can only be accessed using an integer index.
	/// Indexes in this collection are zero-based.
	/// </remarks>
	[Serializable()]
	public class LICollection<T> : Collection<T>
	{
		#region Events
		...
		/// <see cref="LICollection{T}">LICollection</see> class.
		/// </summary>
		public LICollection(): base() {}
		...
		public LICollection(IEnumerable<T> collection): base()
		{
			AddRange(collection);
		}
		...
		/// <summary>
		/// Converts the elements in the current LICollection to another type, 
		...
		/// <returns>A LICollection of the target type containing 
		/// the converted elements from the current LICollection.</returns>
		public LICollection<TOutput> ConvertAll<TOutput>(Converter<T, TOutput> converter)
		{
			if (converter == null) throw new ArgumentNullException("converter");
			
			LICollection<TOutput> list = new LICollection<TOutput>();
     	...
     	/// <summary>
		/// Returns a LICollection which represents a subset of the elements in the source LICollection.
		/// </summary>
		/// <param name="index">The zero-based LICollection index at which the range starts.</param>
		/// <param name="count">The number of elements in the range.</param>
		/// <returns>A LICollection which represents a subset of the elements 
		/// in the source LICollection.</returns>
		public LICollection<T> GetRange(int index, int count) 
		{
			LICollection<T> rangeList = new LICollection<T>();
