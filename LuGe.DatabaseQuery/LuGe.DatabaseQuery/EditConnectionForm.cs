...
{
	/// <summary>
	/// Form for editing a existing connection.
	/// </summary>
	/// <remarks>
	...
	{        
		...
		private string _oldConnectionName;
		...
		private bool CheckValues()
		{
			...
			if ((_settings.Connections.Contains(textBoxName.Text))
			     && (textBoxName.Text != _oldConnectionName))
			{
		...
		{
			_oldConnectionName = ConnectionName;
			PopulateProviderList();
			
			ConnectionInfo setting = _settings.Connections[ConnectionName];
			
			comboBoxProvider.Text = setting.ProviderName;
		...
		private void ButtonUpdateClick(object sender, EventArgs e)
		{
			...
			ConnectionInfo connection = _settings.Connections[_oldConnectionName];
